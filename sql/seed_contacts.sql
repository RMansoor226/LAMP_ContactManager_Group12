...
VALUES ('Jane', 'Doe', 'JDoe', 'password1', CURRENT_DATE(), '2026-9-9');
...
('John', 'Doe', 'johndoe@realmail.com', '123-456-7890', '2026-9-9', '2026-9-9', (SELECT ID FROM Users WHERE ID=1));

-- 3. Seed Initial Palette Colors for User ID 2 (HDTV)
INSERT INTO `Contacts` (`FirstName`, `LastName`, `Email`, `PhoneNumber`, `DateCreated`, `DateUpdated`, `UserID`) VALUES 
('Chad', 'Jepardtee', 'notAIatall@email.com', '987-654-3210', '2024-10-23', '2026-6-10', (SELECT ID FROM Users WHERE ID=2));
